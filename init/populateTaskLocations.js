 ...
 * Add TaskLocations
 */
const populateTaskLocations = function populateAllTaskLocations() {
  // coffee lab
  ...
  // spac
  dbFunctions.addTaskLocationToDB(new Parse.GeoPoint(42.059284, -87.673826), 'rIzJ4nI1lp', 'gym', 'SPAC',
    {
      'sunday': [['8:00', '22:00']],
      'monday': [['6:00', '23:00']],
      'tuesday': [['6:00', '23:00']],
  ...
  // mudd common area
  dbFunctions.addTaskLocationToDB(new Parse.GeoPoint(42.058169, -87.674423), 'tfTCPUaMUD', 'workspace', 'Mudd Common Area (outside library)',
    {
      'sunday': [['10:00', '24:00']],
      'monday': [['00:00', '24:00']],
      'tuesday': [['00:00', '24:00']],
  ...
  // main 1south
  dbFunctions.addTaskLocationToDB(new Parse.GeoPoint(42.052815, -87.674501), 'iej4zTQOFV', 'workspace', 'Main 1South',
    {
...
module.exports = {
  populateTaskLocations: populateTaskLocations
};
