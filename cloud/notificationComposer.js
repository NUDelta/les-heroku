...
exports.fetchScaffoldedInformationForTag = function(tag, currentInfo, locationCommonName) {
  switch (tag) {
    case 'coffeeshops':
...
function createScaffoldedInfoForWorkspaces(currentInfo, locationCommonName) {
  // let locationPhrase = (locationCommonName === '') ? 'here' : 'in ' + locationCommonName;
  // var output = {
  //   'notificationCategory': '', // classtag_questiontag
  //   'message': '', // notification message to present
...
function createScaffoldedInfoForCafes(currentInfo, locationCommonName) {
  // let locationPhrase = (locationCommonName === '') ? 'here' : 'in ' + locationCommonName;
  // var output = {
  //   'notificationCategory': '', // classtag_questiontag
  //   'message': '', // notification message to present
...
function createScaffoldedInfoForGyms(currentInfo, locationCommonName) {
  // let locationPhrase = (locationCommonName === '') ? 'here' : 'in ' + locationCommonName;
  // var output = {
  //   'notificationCategory': '', // classtag_questiontag
  //   'message': '', // notification message to present
